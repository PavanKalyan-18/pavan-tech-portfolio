    ...
    <section id="services" className="py-24 relative">
      <div className="container mx-auto px-6">
        <SectionHeading
          ...
          title={
            <>
              Data <span className="text-gradient">Analytics Skills</span>
            </>
          }
          description="Practical data analytics capabilities I use to clean, analyze, visualize, and communicate insights from structured datasets."
        />
